...
OffboardControl::OffboardControl(rclcpp::Node::SharedPtr node) : node_(node) {
  ...
  timesync_sub_ = node_->create_subscription<px4_msgs::msg::Timesync>(
      "Timesync_PubSubTopic", 10, std::bind(&OffboardControl::timeSyncCallback, this, std::placeholders::_1));
  ...
  angular_velocity_subs_ = node_->create_subscription<px4_msgs::msg::VehicleAngularVelocity>(
      ...
      std::bind(&OffboardControl::vehicleAngularVelocityCallback, this, std::placeholders::_1));
